...
public class FriendInvitation extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnInviteFriend = findViewById(R.id.btnInviteFriend);
        ...
        btnInviteFriend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(FriendInvitation.this, "Friend Invitation Successful", Toast.LENGTH_SHORT).show();
                startActivity(new Intent(FriendInvitation.this,LocationSearch.class));
            }
        });
    }
